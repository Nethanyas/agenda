$(function() {
    ...
    function getListarContato() {
        ...
        function criaListagemTabela(jsonDados) {
            ...
            tabela += '<th scope="col">Site</th>'; // <--- ADICIONADO AQUI
            ...
            $.each(jsonDados, function(indice, contato) {
                ...
                tabela += '<td>' + (contato.site ? contato.site : '') + '</td>'; // <--- ADICIONADO AQUI
            ...
            function getFormularioInclusao() {
                ...
                form += '<div class="col-sm-8">';
                form += '<input type="text" class="form-control" id="site" placeholder="Site (ex: www.site.com)">';
                form += '</div>';
                form += '</div>';
                form += '<div class="form-group">';
